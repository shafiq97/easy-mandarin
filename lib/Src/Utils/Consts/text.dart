...
// -- Splash Screen Text
const String tAppName = "Easy Mandarin";
const String tAppTagLine = "Mandarin in easy way!";

// -- On Boarding Text
const String tOnBoardingTitle1 = "Welcome to Easy Mandarin";
const String tOnBoardingTitle2 = "欢迎来到简易普通话";
const String tOnBoardingTitle3 = "Welcome to Easy Mandarin";
...
// -- Welcome Screen Text
const String tWelcomeTitle = "Easy Mandarin";
const String tWelcomeSubTitle = "当学习是一种享受的时候";

// -- Login Screen Text
const String tLoginTitle = "Welcome Back,";
const String tLoginSubTitle = "Welcome!.";
...
const String tHomeHeading = "继续努力吧!";
